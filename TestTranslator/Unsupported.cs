...
public class UnsupportedCodeTests
{
    ...
    public void Unsupported_Function_Call_1()
    {
        ...
        Assert.That(result, Does.Contain("/* Unimplemented function call: print(123) */"));
    }

    [Test]
    public void Unsupported_Function_Call_2()
    {
        ...
        Assert.That(result, Does.Contain("/* Unimplemented function call: println(123) */"));
    }
    ...
    [Test]
    public void Unsupported_Code_3()
    {
